...
//Commands
	...
	// reset
	public static final String LEVEL_NOT_A_NUMBER_ERROR = "The level must be a number: %s";
	public static final String LEVEL_NOT_VALID = "Not valid level number";
	
	// action
	public static final String ACTION_INCORRECT_EMPTY_LIST =
	    "Incorrect 'action command', because the action list is empty (all actions are unknown).";
	...
	public static final String OBJECT_PARSE_TOO_MANY_ARGS =
	    "Object parse error, too much args: \"%s\"";
	public static final String OBJECT_INVALID_POSITION =
	    "Invalid object position: \"%s\"";
	public static final String POSITION_INVALID = "Invalid position: \"%s\"";
	public static final String UNKNOWN_GAME_OBJECT =
	    "Unknown game object: \"%s\"";
	public static final String UNKNOWN_MOVING_OBJECT_DIRECTION =
	    "Unknown moving object direction: \"%s\"";
	public static final String INVALID_MOVING_OBJECT_DIRECTION =
	    "Invalid moving object direction: \"%s\"";
	public static final String INVALID_MARIO_SIZE =
	    "Invalid Mario size: \"%s\"";
	public static final String INVALID_BOX_STATUS =
	    " Invalid Box status: \"%s\""; 
	
	
	// save/load
	public static final String SAVE_INCORRECT_PARAMETER_NUMBER =
	    "Incorrect parameter number";
	public static final String LOAD_INCORRECT_PARAMETER_NUMBER =
	    "Incorrect parameter number";

	public static final String UNABLE_TO_LOAD_FILE =
	    "Unable to load game configuration from file \"%s\"";
	public static final String FILE_NOT_FOUND =
	    "File not found: \"%s\"";
	public static final String INVALID_FILE_CONFIGURATION =
	    "Invalid file \"%s\" configuration";
	public static final String INCORRECT_GAME_STATUS =
	    "Incorrect game status \"%s\"";
	...
	public static final String INVALID_OBJECT = "Invalid game object: ";
...
//Symbols
	...
	public static final String UNABLE_TO_SAVE = " Unable to save game configuration to file \"%s\"";
